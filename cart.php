...
?>
             ...
             ';
                                  ...
                                  ريال  <?php echo  $result->PRODISPRICE ; ?>
                                  </td>
                                  <td class="input-group custom-search-form" >
                                     ...
                                     <td> ريال <output id="Osubtot<?php echo $result->PROID ?>"><?php echo   $_SESSION['gcCart'][$i]['price'] ; ?></output></td>
                                </tr>
                        ...
                        <h3 align="right"> Total  ريال<span id="sum">0</span></h3> 
    </div>
  </div>  
