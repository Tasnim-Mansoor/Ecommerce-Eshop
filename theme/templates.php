            ...
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav" style="background-color: black;">     
                ...
                <?php if (isset($_SESSION['CUSID'] )) { ?>  
                  <li><a href="<?php echo web_root?>index.php?q=profile"><i class="fa fa-user"></i> الحساب</a></li>     
                  <li><a   href="<?php echo web_root?>logout.php"><i class="fa fa-lock"></i> تسجيل الخروج</a></li>
                <?php }else{ ?> 
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li class="dropdown"><a href="#">الاقسام<i class="fa fa-angle-down"></i></a>
                ...
                <li><a href="<?php web_root?>index.php?q=contact">تواصل معنا</a></li>
             
                <li><a href="aboutus.php">من نحن</a></li>
                <li><a href="<?php echo web_root;?>" class="active">الرئيسية</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
...
<!--
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left"><span><a href="https://www.facebook.com/profile.php?id=61558066557405&mibextid=ZbWKwL"></a><a href="https://www.facebook.com/profile.php?id=100082964841372"></span>حميع الحقوق محفوظة@Tmay Anime</p></a>
          <p class="pull-right">Designed by <span><a target="_blank" href="https://www.facebook.com/profile.php?id=61558066557405&mibextid=ZbWKwL">Tasn CodeArt</a></span></p>
        </div>
      </div>
    </div>
