            ...
            <tr>
              ...
              ?>
                         ...
                         <td></td>
                          ...
                          <td>ريال <?php echo  $result->PRICE ?></td>
                          <td>ريال <output><?php echo $_SESSION['fixnmix_cart'][$i]['price']?></output></td>
                        </tr>
              <?php
                        }
              ...
              <!--   <div class="col-md-6 pull-left">
                ...
                <div class="col-md-4 pull-right">
                  <!-- <div>Total Price : ريال <?php echo number_format($tot,2);?></div> -->
                  <!-- <div>Delivery Fee : ريال <?php echo number_format($price,2); ?></div> -->
                  <div>Overall Price : ريال <?php echo number_format($cur->TOTALPRICE,2); ?></div>
                </div>
              </div>
