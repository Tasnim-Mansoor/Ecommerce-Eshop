	...
	"post">
				...
				<?php
				  ...
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td> ريال '.number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> ريال <output><?php echo number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
       ...
       <div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : ريال <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : ريال <?php echo number_format($cur->DELFEE,2); ?></p>
		  		<p align="right">Overall Price : ريال <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div> 
		</div>   
