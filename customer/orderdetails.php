      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>ريال <?php echo  $result->PRODISPRICE ?></td>
                          <td>ريال <output><?php echo $_SESSION['gcCart'][$i]['price']?></output></td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Total Price :   ريال <span id="sum">0.00</span></div>
                   <div > Delivery Fee : ريال <span id="fee">0.00</span></div>
                   <div> Overall Price : ريال <span id="overall"><?php echo $tot ;?></span></div>
