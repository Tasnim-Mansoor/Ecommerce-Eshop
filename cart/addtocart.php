  ...
  <?php check_message(); ?>
      <div class="">
        <div class="panel panel-default">
          ...
          <div>Every products has a mininum price of ريال 50.00 each to be able to order.</div>
      <div class="table-responsive">
       <div  class="fixnmix_scroll_carttwo" >
         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <td>ريال <?php echo number_format($result->PRICE,2) ?></td>
                        ...
                        <td>ريال <output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price'] ; ?></output>
        ...
        ?>
                  ...
                  <table  >
                  <tfoot >
                     <strong><h1 align="right">Total Price : ريال <span style="margin-right:3%"  id="sum">0.00</span></h1></strong></td>
