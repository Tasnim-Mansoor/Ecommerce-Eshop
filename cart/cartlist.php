                ...
                <div class="panel panel-default panel-shadow">
                    ...
                    <div class="table-responsive">
                         ...
                         <body onload=" totalprice(); ">
                              ...
                              <form id="form" action="cart/controller.php?action=edit" method="POST"  
                                  ...
                                  <div class="column4">                                  
                                    ...
                                    <!-- <div style="float: right; width:100px"></div> -->
                                     <div style="float: left; width:50px">&nbsp;&nbsp;ريال<span id="price1"><?php echo $result->PRICE; ?></span></div>
                                     <div  id="test" style="float: right; width:50px">ريال<output name="TOTAL" for="QTY price"></output></div>                                     
                                  </div>
                              </form> 
                            ...
                            <tr >  
                            <td>                               
                             <div class="culomn4"><div style="float: right;"><h1> Total Price : ريال<span id="sum">0</span></h1></div></div>
                            </td>                        
